...
class TestCreateBankAccount(unittest.TestCase):
    ...
    def test_account_correct_promo_code(self):
        bonus_srodki = 50
        account = Account(self.name, self.surname, self.pesel, self.correct_promo_code)
    ...
    def test_account_wrong_promo_code(self):
        ...
        account = Account(self.name, self.surname, self.pesel, promo_code)
    ...
    def test_born_before_1900(self):
        ...
        account = Account(self.name, self.surname, pesel, self.correct_promo_code)
